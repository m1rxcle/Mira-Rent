		...
		<form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<div className="space-y-2">
					...
					<Input id="color" {...register("color")} placeholder="black" className={errors.color ? "border-red-500" : ""} />
				...
				<div className="space-y-2">
					<Label htmlFor="seats">
						Number of Seats<span>(Optional)</span>{" "}
					</Label>
			...
			<div className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 ">
				...
				<div className="space-y-1 leading-none ">
					...
					<p className="text-sm text-gray-500">Featured cars appear on the home page</p>
				</div>
			</div>
				...
				<div>
					...
					>
						...
						<div className="flex flex-col items-center justify-center">
							...
							<p className="text-gray-600 text-sm">Drag & drop or click to upload multiple images</p>
